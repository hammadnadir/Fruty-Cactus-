...
export default function Tripletap_delta9o_navbar() {
    const dispatch = useDispatch();
  return (
    <div className=' bg-[url("/images/tripletap_delta9o_navbar.png")] w-[100%] bg-cover md:mt-[-40px]  md:h-[210px] bg-no-repeat fixed z-10'>
